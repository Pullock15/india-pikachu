...
function clearlevel2 () {
    for (let value of sprites.allOfKind(SpriteKind.NPC5)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.NPC6)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.NPC7)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.NPC8)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.NPC9)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.NPC10)) {
        value.destroy()
    }
    for (let value of sprites.allOfKind(SpriteKind.NPC11)) {
        value.destroy()
    }
    level += 1
    Createlevel()
